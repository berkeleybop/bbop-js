...
each(refgen_taxa,
	 ...
	 each(panther_families,
		  ...
		  var count = family_count_set[1]; // get count part

		  // Ensure.
		  if( ! bbop.core.is_defined(family_cache[family]) ){
		      family_cache[family] = 0;
		  }

		  family_cache[family] = family_cache[family] + count;
	      });
