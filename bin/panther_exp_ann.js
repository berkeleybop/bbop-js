#!/usr/bin/rhino
/* 
 * Package: panther_exp_ann_per_mod.js
 * 
 * This is a Rhino script.
 * 
 * For every PANTHER family, return the number of experimental
 * annotations per reference genome mod.
 * 
 * Usage like:
 * : panther_exp_ann_per_mod.js
 */
