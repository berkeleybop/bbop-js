...
amigo.data.server = function(){
    ...
    var meta_data = {"ontologies":[],"galaxy_base":"http://galaxy.berkeleybop.org/","html_base":"http://localhost/amigo2","species":[],"evidence_codes":{},"bbop_img_star":"http://localhost/amigo2/images/star.png","image_base":"http://localhost/amigo2/images","app_base":"http://localhost/cgi-bin/amigo2","term_regexp":"^all$|^GO:[0-9]{7}$","species_map":{},"beta":"1","golr_base":"http://localhost:8080/solr/","gp_types":[],"sources":[]};
