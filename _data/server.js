...
amigo.data.server = function(){
    ...
    var meta_data = {"js_base":"http://localhost:9999/static/js","term_regexp":"all|GO:[0-9]{7}","evidence_codes":{},"beta":"1","js_dev_base":"http://localhost:9999/static/staging","html_base":"http://localhost:9999/static","ontologies":[],"gp_types":[],"golr_base":"http://localhost:8080/solr/","sources":[],"species_map":{},"app_base":"http://localhost:9999","image_base":"http://localhost:9999/static/images","galaxy_base":"http://galaxy.berkeleybop.org/","css_base":"http://localhost:9999/static/css","bbop_img_star":"http://localhost:9999/static/images/star.png","species":[]};
