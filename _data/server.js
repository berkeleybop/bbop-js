...
amigo.data.server = function(){
    ...
    var meta_data = {"evidence_codes":{},"js_dev_base":"http://localhost:9999/static/staging","html_base":"http://localhost:9999/static","css_base":"http://localhost:9999/static/css","bbop_img_star":"http://localhost:9999/static/images/star.png","golr_base":"http://localhost:8080/solr/","image_base":"http://localhost:9999/static/images","galaxy_base":"http://galaxy.berkeleybop.org/","ontologies":[],"species":[],"term_regexp":"all|GO:[0-9]{7}","beta":"1","app_base":"http://localhost:9999","sources":[],"js_base":"http://localhost:9999/static/js","species_map":{},"gp_types":[]};
