...
amigo.data.server = function(){
    ...
    var meta_data = {"beta":"1","js_base":"http://localhost:9999/static/js","term_regexp":"all|GO:[0-9]{7}","css_base":"http://localhost:9999/static/css","species":[],"golr_base":"http://localhost:8080/solr/","app_base":"http://localhost:9999","html_base":"http://localhost:9999/static","ontologies":[],"js_dev_base":"http://localhost:9999/static/staging","gp_types":[],"evidence_codes":{},"bbop_img_star":"http://localhost:9999/static/images/star.png","galaxy_base":"http://galaxy.berkeleybop.org/","image_base":"http://localhost:9999/static/images","sources":[],"species_map":{}};
