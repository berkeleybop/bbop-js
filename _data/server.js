...
amigo.data.server = function(){
    ...
    var meta_data = {"term_regexp":"all|GO:[0-9]{7}","galaxy_base":"http://galaxy.berkeleybop.org/","golr_base":"http://localhost:8080/solr/","app_base":"http://localhost:9999","js_dev_base":"http://localhost:9999/static/staging","bbop_img_star":"http://localhost:9999/static/images/star.png","js_base":"http://localhost:9999/static/js","species":[],"html_base":"http://localhost:9999/static","sources":[],"ontologies":[],"evidence_codes":{},"species_map":{},"css_base":"http://localhost:9999/static/css","beta":"1","image_base":"http://localhost:9999/static/images","gp_types":[]};
