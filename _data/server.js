...
amigo.data.server = function(){
    ...
    var meta_data = {"evidence_codes":{},"ontologies":[],"sources":[],"term_regexp":"all|GO:[0-9]{7}","css_base":"http://localhost:9999/static/css","bbop_img_star":"http://localhost:9999/static/images/star.png","golr_base":"http://localhost:8080/solr/","gp_types":[],"image_base":"http://localhost:9999/static/images","species":[],"beta":"1","js_base":"http://localhost:9999/static/js","app_base":"http://localhost:9999","js_dev_base":"http://localhost:9999/static/staging","html_base":"http://localhost:9999/static","galaxy_base":"http://galaxy.berkeleybop.org/","species_map":{}};
