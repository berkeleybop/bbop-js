...
renderer.prototype.show_pgraph = function(pgraph) {
    ...
    // this.node_menu_elem = jQuery(document.createElement("div"));
    // this.node_menu_elem.css({
    //     display: "none",
    //     position: "relative"
    // });
    // jQuery(this.parent).append(this.node_menu_elem);
...
renderer.prototype.render_tree = function() {
    ...
    // this.tree_renderer.iterate_preorder(
    //     function(id, label, meta, dom_elem, children) {
    //         var jqElem = jQuery(dom_elem);
    //         //jqElem.attr("rel", "popover");
    //         jqElem.popover({
    ...
    //             hideButton.click(function() {
    //                 jqElem.popover("hide");
    //                 self.toggle_subtree_shown(id);
    //                 jQuery(this).text( self.tree_renderer.subtree_hidden(id)
    //                                    ? "Show subtree"
    //                                    : "Hide subtree" );
    //             });
    //             hideButton.text( self.tree_renderer.subtree_hidden(id)
    //                              ? "Show subtree"
    //                              : "Hide subtree" );
    //             podata.tip().append(hideButton);
    //             podata.tip().append("&nbsp;");
    ...
    //             rootButton.click(function() {
    //                 jqElem.popover("hide");
    //                 if (self.tree_renderer.only_subtree_shown(id)) {
    //                     self.show_global_root();
    //                 } else {
    //                     self.show_only_subtree(id);
    //                 }
    //                 jQuery(this).text( self.tree_renderer.only_subtree_shown(id)
    //                                    ? "Show global root"
    //                                    : "Show only subtree" );
    //             });
    //             rootButton.text( self.tree_renderer.only_subtree_shown(id)
    //                              ? "Show global root"
    //                              : "Show only subtree" );
    //             podata.tip().append(rootButton);
    //             podata.tip().append("&nbsp;");
