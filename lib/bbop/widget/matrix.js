...
function renderer(parent, row_descriptors, col_descriptors,
    ...
    this.default_stylesheet = [
        //"div." + table_class + " { border-collapse: collapse; }",
        //"div." + table_class + " div.row { ",
        //"  height: " + this.config.cell_height + "px;",
        //"  position: absolute;",
        //"}",
        //"div." + table_class + " tr:nth-child(even)  { background-color:#eee; }",
        //"div." + table_class + " tr:nth-child(odd) { background-color:#fff; }",
        "div." + cell_class + " { ",
        "  position: absolute;",
        "  white-space: nowrap;",
