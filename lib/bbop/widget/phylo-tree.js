...
function renderer(parent, config){
    ...
    this.node_elem_click_handler = function(event) {
        ...
        self.node_clicked(node, node_elem);
    };
...
renderer.prototype.is_hidden = function(node_id) {
...
renderer.prototype.display = function () {
	...
	// Create node at place. 
        ...
        // add node_id to the node element for the click event handler
        phynode.node_elem.node_id = node_pos.id;
...
renderer.prototype._do_layout = function() {
    var leaf_counter = 0;
    var self = this;
    return Array.prototype.concat.apply([], this.tree.traverse(
        function(node, down_data) {
            return down_data + node.parent_distance;
        },
        0,
