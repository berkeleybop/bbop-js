...
renderer.prototype.display = function () {
	...
	// Create node at place. 
        var phynode = new graph_pnode(this.tree.nodes[node_pos.id].label,
                                      lpx, lpy,
...
renderer.prototype.sort_tree = function(sort) {
...
renderer.prototype.is_sorted = function() {
...
renderer.prototype.iterate = function(callback) {
    var self = this;
    this.tree.iterate_postorder(function(node) {
        callback(node.id, node.label, node.meta,
