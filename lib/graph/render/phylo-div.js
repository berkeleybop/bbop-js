...
bbop.render.phylo.renderer = function (element_id, config){
	...
	this.row_height = this.config.box_height + this.config.box_spacing;
        ...
        this.tree_height =
            (layout.max_width * this.row_height)
	...
	this._render_frame_width = this.parentElem.offsetWidth;
        this.container.style.width =
            (this._render_frame_width - this.max_leaf_width) + "px"
    };        
